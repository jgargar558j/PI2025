...
export default class HUD extends Phaser.Scene{
    ...
    create():void{
        ...
        this.timeTxt = this.add.bitmapText(this.cameras.main.width / 2,20,Constants.FONTS.BITMAP, '05:00',20);
    }
    ...
    createHudControls() {
        ...
        const baseX = this.cameras.main.width - controlSize - padding;
        const baseY = this.cameras.main.height - controlSize - padding;
    
        this.leftControl = this.add.sprite(baseX - controlSize - padding, baseY, Constants.CONTROLS.LEFT)
            .setOrigin(0.5, 0.5)
            .setInteractive()
            .setScale(scaleFactor);
    
        this.rightControl = this.add.sprite(baseX, baseY, Constants.CONTROLS.RIGHT)
            .setOrigin(0.5, 0.5)
            .setInteractive()
            .setScale(scaleFactor);
    
        this.upControl = this.add.sprite(baseX - (controlSize / 2), baseY - controlSize / 2 - padding, Constants.CONTROLS.UP)
            .setOrigin(0.5, 0.5)
            .setInteractive()
            .setScale(scaleFactor);
