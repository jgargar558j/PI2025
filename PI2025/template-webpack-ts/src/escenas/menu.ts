...
export default class Menu extends Phaser.Scene{
    ...
    createBackground(){
        this.add.image(this.width/2, this.height/2, 'logo').setScale(0.4).setOrigin(0.5,0.5);
    ...
    createPlayText(){
        const playTxtShadow = this.add.bitmapText(
            this.width / 2,
            this.height / 1.1,
    ...
    createSettingsTxt(){
        ...
        const settingsTxt : Phaser.GameObjects.BitmapText = this.add.bitmapText(
            ...
            this.height / 1.2,
            Constants.FONTS.BITMAP,
            Constants.TEXTS.MENU.SETTINGS, 25
        ).setInteractive();
    ...
    createCreditsTxt(){
        ...
        const creditsTxt : Phaser.GameObjects.BitmapText = this.add.bitmapText(
            ...
            this.height / 1.2,
            Constants.FONTS.BITMAP,
            Constants.TEXTS.MENU.CREDITS, 25
        ).setInteractive();
    ...
    changeSceneToSettings(settingsTxt: Phaser.GameObjects.BitmapText, scene: string) {
