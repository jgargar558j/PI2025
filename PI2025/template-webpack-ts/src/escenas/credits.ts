...
export default class Credits extends Phaser.Scene {
  ...
  createCreditsText() {
    ...
    const developerTxtShadow = this.add
      .bitmapText(
        this.width / 2,
        this.height / 4,
        Constants.FONTS.BITMAP,
    ...
    const developerTxt: Phaser.GameObjects.BitmapText = this.add
      .bitmapText(
        this.width / 2,
        this.height / 4,
        Constants.FONTS.BITMAP,
    ...
    //Version 1.0
    const gameTitleTxtShadow = this.add
      .bitmapText(
        this.width / 2,
        this.height / 3,
        Constants.FONTS.BITMAP,
    ...
    const gameTitleTxt: Phaser.GameObjects.BitmapText = this.add
      .bitmapText(
        this.width / 2,
        this.height / 3,
        Constants.FONTS.BITMAP,
    ...
    //Version 1.0
    const versionTxtShadow = this.add
      .bitmapText(
        this.width / 2,
        this.height / 2.4,
        Constants.FONTS.BITMAP,
    ...
    const versionTxt: Phaser.GameObjects.BitmapText = this.add
      .bitmapText(
        this.width / 2,
        this.height / 2.4,
        Constants.FONTS.BITMAP,
    ...
    const spritesTxtShadow = this.add
      .bitmapText(
        this.width / 2,
        this.height / 2,
        Constants.FONTS.BITMAP,
    ...
    const spritesTxt: Phaser.GameObjects.BitmapText = this.add
      .bitmapText(
        this.width / 2,
        this.height / 2,
        Constants.FONTS.BITMAP,
    ...
    //Música del menú
    const musicMenuTxtShadow = this.add
      .bitmapText(
        this.width / 2,
        this.height / 1.6,
        Constants.FONTS.BITMAP,
    ...
    const musicMenuTxt: Phaser.GameObjects.BitmapText = this.add
      .bitmapText(
        this.width / 2,
        this.height / 1.6,
        Constants.FONTS.BITMAP,
    ...
    //Música INGAME
    const musicGameTxtShadow = this.add
      .bitmapText(
        this.width / 2,
        this.height / 1.3,
        Constants.FONTS.BITMAP,
    ...
    const musicGameTxt: Phaser.GameObjects.BitmapText = this.add
      .bitmapText(
        this.width / 2,
        this.height / 1.3,
        Constants.FONTS.BITMAP,
  ...
  changeSceneToMenu(backTxt: Phaser.GameObjects.BitmapText, scene: string) {
    let clickSound: Phaser.Sound.BaseSound = this.sound.add(Constants.SOUNDS.EFFECTS.CLICK, {
      loop: false,
      volume: 2,
    });
